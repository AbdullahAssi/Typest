  ...
  return (
    <div className="m-auto flex h-[90%] w-[90%] flex-col gap-7 py-10 font-mono text-lg">
      <div className="flex flex-col gap-3">
        <h1 className="text-3xl font-bold">About Typest</h1>
        <p className="">
          Typest is a minimalistic typing speed testing app built with React and
          TailwindCSS that highly inspired by{" "}
          <a
      ...
      <div className=" mt-auto flex flex-col gap-1">
        <div className="flex items-center gap-3">
          ...
          <a
            href="https://www.linkedin.com/in/muhammad-abdullah-796597246/"
            target="_blank"
            className="hover:underline"
          ...
          ,
          <a
            href="https://www.instagram.com/abdullahassi225/"
            target="_blank"
            className="hover:underline"
            rel="noopener noreferrer"
          >
